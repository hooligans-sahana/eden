...
'Coordinate the provision of emergency services and assistance during or after a\
 disaster in order to save lives, reduce health impacts, ensure public safety and meet the needs of the people affected': 'Coordenar a prestação de serviços e assistência de emergência durante ou após um desastre, a fim de salvar vidas, reduzir os impactos na saúde, garantir a segurança pública e atender às necessidades das pessoas afetadas',
...
'Latest Events': 'Útimos Eventos',
'Latest Alerts': 'Útimos Alertas',
