...
'Add Situation Report': 'Adicionar Relatório de Situação',
...
'Aircraft Maximum Size': 'Tamanho Máximo de Avião',
...
'Alert': 'Alerta',
'All': 'Tudo',
'All data added to SPGDRJ will be publicly available and can be freely shared, copied, distributed and adapted.': 'Todos os dados adicionados ao SPGDRJ estarão disponíveis publicamente e podem ser livremente compartilhados, copiados, distribuídos e adaptados.',
...
'All Stakeholders engaged in disaster risk management work in Rio de Janeiro can use the Rio de Janeiro Disaster Risk Management Information System to share information to better plan and coordinate their activities.': 'Todas as partes interessadas envolvidas no trabalho de gestão de risco de desastres no Rio de Janeiro podem usar o Sistema de Informação de Gestão de Risco de Desastres do Rio de Janeiro para compartilhar informações para melhor planejar e coordenar suas atividades.',
...
'Border Crossing': 'Posto de Controle de Fronteira',
'Border Crossings': 'Postos de Controle de Fronteira',
'Both': 'Ambos',
...
'By Site': 'Por Site',
'By using the Disaster Prevention and Management System in Rio de Janeiro (SPGDRJ), you agree to these Terms of Service.': 'Ao utilizar o Sistema de Prevenção e Gerenciamento de Desastres no Rio de Janeiro (SPGDRJ), concorda com estes Termos de Serviço.',
'c/o Name': 'c/o Nome',
'Calculate': 'Calcular',
'Camp': 'Acampamento',
...
'Committed Items': 'Itens Comprometidos',
...
'Contact details': 'Detalhes do Contato',
'Contact Directory': 'Diretório de Contatos',
...
'Control Points': 'Postos de Controle',
...
'Coordinate the provision of emergency services and assistance during or after a disaster in order to save lives, reduce health impacts, ensure public safety and meet the needs of the people affected': 'Coordenar a prestação de serviços de emergência e assistência durante ou após um desastre, a fim de salvar vidas, reduzir os impactos na saúde, garantir a segurança pública e atender às necessidades das pessoas afetadas',
...
'Create Airport': 'Criar Aeroporto',
'Create Assessment': 'Criar Avaliação',
'Create Asset': 'Criar Ativo',
'Create Bed Type': 'Criar Tipo De Cama',
'Create Border Control Point': 'Criar posto de controle de fronteira',
'Create Border Crossing': 'Criar Posto de Controle de Fronteira',
...
'Create Department': 'Criar Departamento / Unidade',
'Create Event': 'Criar Evento',
'Create Event Type': 'Criar Tipo de Evento',
'Create Facility': 'Criar Recurso',
'Create Facility Type': 'Criar Tipo de Instalação',
'Create Feature Layer': 'Criar camada de recurso',
'Create Group': 'Criar Grupo',
'Create Group Entry': 'Criar Grupo De Entrada',
'Create Heliport': 'Criar Heliporto',
...
'Create Resource Type': 'Criar Tipo de Recurso',
...
'Create Training Event': 'Criar Eventos de Treinamento / Capacitação',
...
'Department Catalog': 'Catálogo de Departamento / Unidades',
...
'Disaster Prevention and Management System in Rio de Janeiro - SPGDRJ': 'Sistema de Prevenção e Gerenciamento de Desastres no Rio de Janeiro - SPGDRJ',
...
'Facility Types': 'Tipos de Instalações',
...
'Fire': 'Fogo',
'Fire Stations': 'Corpo de Bombeiros',
...
'Fog': 'Nevoeiro',
'Food (per person/day)': 'Alimento (por pessoa/dia)',
...
'Heavy Equipment': 'Equipamentos Pesados',
'Height': 'Altura',
'Height (cm)': 'Altura (cm)',
'Height (m)': 'Altura (m)',
'Heliports': 'Heliportos',
'Help': 'Ajuda',
'HELP': 'Ajuda',
...
'Humanitarian Use': 'Uso Humanitário',
'Hurricane': 'Furacão',
...
'Imagery': 'Imagens',
'Images': 'Imagens',
'Immediate Needs': 'Necessidades Imediatas',
...
'Import Border Crossings': 'Importar Postos de Controle de Fronteira',
'Import Data': 'Importar Dados',
'Import File': 'Importar Arquivo',
'Import from Ushahidi Instance': 'Importação da Instância Ushahidi',
'Import Heliports': 'Importar Heliporto',
...
'Improving disaster prevention, preparedness and response in Rio de Janeiro.': 'Melhorar a prevenção, preparação e resposta a desastres no Rio de Janeiro.',
...
'Incident Commander': 'Comandante de Operações no Incidente',
...
'Job Roles': 'Funções',
'Job Title': 'Cargo',
'Job Title Catalog': 'Catálogo de Cargos',
'Jobs': 'Tarefas',
'Journal': 'Diário',
...
'Latest Alerts': 'Últimos Alertas',
'Latest Events': 'Últimos Eventos',
'Latest Information': 'Últimas Informações',
...
'Link to this result': 'Link para este resultado',
'List': 'Listar',
...
'List All Vehicles': 'Lstar todos os veículos',
...
'List Recurring Requests': 'Lista de solicitações recorrentes',
...
'Monetization Report': 'Relatório de Rentabilidade',
...
'Needs Financing?': 'Necessita de financiamento?',
...
'No options available': 'Sem opções disponíveis',
...
'Organization Types': 'Tipos de Organização',
...
'Other buildings': 'Outras estruturas',
...
'Remove existing data before import': 'Remova os dados existentes antes de importar',
...
'Requested For Facility': 'Solicitação de Instalação',
...
'Resource Inventory': 'Inventário de Recursos',
...
'Runway Length (m)': 'Comprimento da Pista (m)',
'Runway Surface': 'Superfície da Pista',
'Runway Width (m)': 'Largura  da Pista (m)',
...
'Search All Requested Items': 'Pesquisar Todos os Itens Solicitados',
...
'Search by Skills': 'Busca por Habilidades',
...
'Share information to coordinate, cooperate, and collaborate with stakeholders in Rio de Janeiro county to avoid potential adverse impacts of disasters through advanced actions': 'Compartilhar informações para coordenar, cooperar e colaborar com as partes interessadas no Estado do Rio de Janeiro para evitar potenciais impactos adversos de desastres por meio de ações avançadas',
'Share information, knowledge and capacities to effectively anticipate, respond to, and recover from, the impacts of likely, imminent or current hazard events in Rio de Janeiro': 'Compartilhar informações, conhecimentos e capacidades para efetivamente antecipar, responder e se recuperar dos impactos de eventos de risco prováveis, iminentes ou atuais no Rio de Janeiro',
'shaved': 'raspado',
'Shelter': 'Abrigo',
...
'Situation Reports': 'Relatório de Situação',
'Sketch': 'Esboço',
'Skill': 'Habilidade',
...
'SPGDRJ Facilitators may choose to moderate and either ban any user or edit any content which they believe has breached this Code of Conduct.': 'Os facilitadores do SPGDRJ podem escolher moderar e banir qualquer usuário ou editar qualquer conteúdo que eles acreditem ter violado este Código de Conduta.',
...
'Staff & Volunteers (Combined)': 'Colaboradores & Voluntários (Combinados)',
'Staff 2': 'Equipe 2',
...
'Training Events': 'Eventos de Treinamento / Capacitação',
...
'Users': 'Usuários',
'Users must ensure that the content they post is accurate to the best of their knowledge and has been checked.': 'Os usuários devem garantir que o conteúdo que postam seja preciso, de acordo com o melhor de seu conhecimento, e tenha sido verificado.',
'Users must have the approval of their organisation to post content.': 'Os usuários devem ter a aprovação de sua organização para postar conteúdo.',
'Users must not post content which is critical or offensive to other users or stakeholders': 'Os usuários não devem postar conteúdo que seja crítico ou ofensivo para outros usuários ou partes interessadas',
...
'Vehicles': 'Veículos',
'Vehicles are assets with some extra details.': 'Os veículos são ativos com alguns detalhes extras.',
'Venue': 'Local',
...
'Water Sources': 'Fornecimento de Água',
