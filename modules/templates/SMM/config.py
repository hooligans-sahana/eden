...
def config(settings):
    ...
    settings.ui.export_formats = ["xlS", "CSV"]
    ...
    def customise_pr_person_controller(**attr):
        ...
        def custom_prep(r):
            ...
            if r.interactive or r.representation == "aadata":
                ...
                #s3.scripts.append('/%s/static/themes/SMM/js/contacts.js' % request.application)
